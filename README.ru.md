...
Ваши заметки отображаются на мобильных устройствах как обычный markdown. Agile Board — это плагин только для настольных компьютеров — макеты board доступны только на десктопе.
